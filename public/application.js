...
var app = {
  ...
  host: 'https://map-rails-api.herokuapp.com'
};
...
var config = {
  apiOrigins: {
    ...
    production: 'https://map-rails-api.herokuapp.com'
  }
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.kids : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
  ...
  return "  <div data-id=\""
    ...
    + "\" class=\"media-object img-thumbnail\" alt=\"Image\" width=\"150\" height=\"100\">\n      </div>\n      <div class=\"media-body\">\n        <h4 class=\"media-heading\">&nbsp;</h4>\n        <h4 class=\"media-heading\">"
    ...
    + "</h4>\n      </div><br>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"btn btn-primary btn-xs\" data-keyboard=\"false\" data-backdrop=\"static\" data-toggle=\"modal\" data-target=\"#kidModal\">Update Child</button>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"deleteButton\" type=\"button\" class=\"btn btn-danger btn-xs\">Delete</button>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"getBooks\" type=\"button\" class=\"btn btn-success btn-xs\">View My Favorite Books</button>\n    </div>\n    <hr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"kid-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.kids : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var kidEvents = __webpack_require__(36);
var bookEvents = __webpack_require__(39);
...
var authHelper = __webpack_require__(8);
...
var app = __webpack_require__(2);
var authHelper = __webpack_require__(8);
var showKidsTemplate = __webpack_require__(9);
...
var displayUsersChildren = function displayUsersChildren() {
  app.kids = app.user.kids;
  var showKidsHtml = showKidsTemplate({ kids: app.user.kids });
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p>No children found. Please use the \"Add Child\" button</p>\n";
},"useData":true});
...
var onGetKids = function onGetKids(event) {
  if (event.originalEvent !== undefined) {
    $('#result').text('You are home!!');
  }
  event.preventDefault();
  api.getKids().then(ui.getKidsSuccess).catch(ui.failure);
};

var id = void 0;

var onManageKid = function onManageKid(event) {
  event.preventDefault();
  var data = getFormFields(event.currentTarget);
  api.updateKid(data, id).then(ui.updateKidSuccess).catch(ui.updateKidFailure);
};

var onCreateKid = function onCreateKid(event) {
  event.preventDefault();
  var data = getFormFields(event.currentTarget);
  api.createKid(data).then(ui.createKidSuccess).catch(ui.createKidFailure);
};

var onDelete = function onDelete(event) {
  event.preventDefault();
  api.deleteKid(event.target.getAttribute('data-id')).then(ui.deleteKidSuccess).catch(ui.deleteKidFailure);
};

var populateForm = function populateForm(id) {
  var kid = app.kids.find(function (ele) {
    return ele.id === id;
  });
...
var addKidHandlers = function addKidHandlers() {
...
var updateKid = function updateKid(data, id) {
  return $.ajax({
...
var createKid = function createKid(data) {
  return $.ajax({
    url: config.apiOrigin + '/kids', // "http://book-json.herokuapp.com/books"
    method: 'POST',
    headers: {
...
var deleteKid = function deleteKid(id) {
  return $.ajax({
    url: config.apiOrigin + '/kids/' + id, // "http://book-json.herokuapp.com/books"
    method: 'DELETE',
    headers: {
...
var getKidsSuccess = function getKidsSuccess(data) {
  var showKidsHtml = showKidsTemplate({ kids: data.kids });
  app.kids = data.kids;
  $('#kids').html(showKidsHtml);
  delete app.current_kid_id;
};
...
var updateKidSuccess = function updateKidSuccess(data) {
  $('#home').click();
  $('#result').text('Child updated successfully!!');
  $('#kidModal').modal('hide');
};

var updateKidFailure = function updateKidFailure(error) {
...
var createKidSuccess = function createKidSuccess(data) {
  $('#home').click();
  $('#result').text('Child added successfully!!');
  $('#kidModal').modal('hide');
};

var createKidFailure = function createKidFailure(error) {
...
var deleteKidSuccess = function deleteKidSuccess(data) {
  $('#home').click();
  $('#result').text('Delete successful!!');
};

var deleteKidFailure = function deleteKidFailure(error) {
...
module.exports = {
  getKidsSuccess: getKidsSuccess,
  failure: failure,
  updateKidSuccess: updateKidSuccess,
  updateKidFailure: updateKidFailure,
  createKidSuccess: createKidSuccess,
  createKidFailure: createKidFailure,
  deleteKidSuccess: deleteKidSuccess,
  deleteKidFailure: deleteKidFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onManageBook = function onManageBook(event) {
  event.preventDefault();
  var data = getFormFields(event.currentTarget);
  data.book.kid_id = app.current_kid_id;
  api.updateBook(data, bookId).then(ui.updateBookSuccess).then(onGetBooks).catch(ui.updateBookFailure);
};
...
var onCreateBook = function onCreateBook(event) {
  ...
  var data = getFormFields(event.currentTarget);
  data.book.kid_id = app.current_kid_id;
  api.createBook(data).then(ui.createBookSuccess).then(onGetBooks).catch(ui.createBookFailure);
};

var onDeleteBook = function onDeleteBook(event) {
  event.preventDefault();
  api.deleteBook(event.target.getAttribute('data-id')).then(ui.deleteBookSuccess).then(onGetBooks).catch(ui.deleteBookFailure);
};

var populateForm = function populateForm(id) {
  var book = app.books.find(function (ele) {
    return ele.id === id;
  });
...
var getKidIdData = function getKidIdData() {
  return {
    'book': {
...
var showBooksTemplate = __webpack_require__(42);
var app = __webpack_require__(2);
...
var getImageHTML = function getImageHTML() {
  if (app.current_kid_id === undefined || app.books === undefined || app.books.length === 0) {
    return '';
  } else {
    var child = app.kids.find(function (ele) {
      return ele.id === app.current_kid_id;
    });
    return "<div class='container-fluid bg-1 text-center'><h4>Here are my favorite books!!</h4><img src=\"" + child.image_url + "\" class='img-circle' alt='Child' width='150' height='150'></div>";
  }
};
...
var updateBookFailure = function updateBookFailure(error) {
  $('#book-content').text('Sorry, some problem while updating, please try later - ' + error.statusText);
  $('#result').text('Sorry, some problem while updating, please try later - ' + error.statusText);
};

var createBookSuccess = function createBookSuccess(data) {
...
var deleteBookSuccess = function deleteBookSuccess(data) {
  $('#result').text('Book deleted successfully!!');
};

var deleteBookFailure = function deleteBookFailure(error) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
  ...
  return "  <div data-id=\""
    ...
    + "</li>\n        </ul>\n      </div><br>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"btn btn-primary btn-xs\" data-keyboard=\"false\" data-backdrop=\"static\" data-toggle=\"modal\" data-target=\"#bookModal\">Update Book</button>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"deleteBookButton\" type=\"button\" class=\"btn btn-danger btn-xs\">Delete</button>\n    </div>\n    <hr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = container.invokePartial(__webpack_require__(43),depth0,{"name":"book-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.books : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"usePartial":true,"useData":true,"useBlockParams":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p>No books found. Please use the \"Add Book\" button</p>\n";
},"useData":true});
